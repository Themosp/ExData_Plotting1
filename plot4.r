...
#Create a .png file with 4 plots in it!
...
plot(plotdata$Timestamp,plotdata$Voltage, xlab="datetime", ylab="Voltage",type="l")
...
plot(plotdata$Timestamp,plotdata$Global_reactive_power, xlab="", ylab="Global Reactive Power (Kilowatts)",type="l")
